  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        ...
        builder: (BuildContext context,
            AsyncSnapshot<DnaGetEpochResponse> _dnaGetEpochResponse) {
          if (_dnaGetEpochResponse.hasData) {
            return FutureBuilder(
                future: httpService.getDnaCeremonyIntervals(
                    Uri.parse(idenaSharedPreferences.apiUrl),
                    idenaSharedPreferences.keyApp),
                builder: (BuildContext context,
                    AsyncSnapshot<DnaCeremonyIntervalsResponse>
                        _dnaCeremonyIntervalsResponse) {
                  if (_dnaCeremonyIntervalsResponse.hasData) {
