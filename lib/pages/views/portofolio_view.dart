...
class PortofolioView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: httpService.getDnaGetBalance(
            Uri.parse(idenaSharedPreferences.apiUrl),
            idenaSharedPreferences.keyApp),
        builder: (BuildContext context,
            AsyncSnapshot<DnaGetBalanceResponse> snapshot) {
          if (snapshot.hasData) {
                                                          ...
                                                          Padding(
                                                            padding:
                                                                const EdgeInsets
                                                                    ...
                                                                    bottom: 1),
                                                            child: Text(
                                                              '${(double.parse(snapshot.data.result.balance) * animation.value).toDouble().toStringAsFixed(4)}',
                                                              textAlign:
                                                                  TextAlign
                                                                      .center,
                                                              style: TextStyle(
                                                          ...
                                                          Padding(
                                                            padding:
                                                                const EdgeInsets
                                                                    ...
                                                                    bottom: 1),
                                                            child: Text(
                                                              '${(double.parse(snapshot.data.result.stake) * animation.value).toDouble().toStringAsFixed(4)}',
                                                              textAlign:
                                                                  TextAlign
                                                                      .center,
                                                              style: TextStyle(
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: <Widget>[
                                                    ...
                                                    Text(
                                                      '${((double.parse(snapshot.data.result.balance) + double.parse(snapshot.data.result.stake)) * animation.value).toInt()}',
                                                      textAlign:
                                                          TextAlign.center,
                                                      style: TextStyle(
                                                        fontFamily:
