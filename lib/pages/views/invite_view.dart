...
class InviteView extends StatefulWidget {
  ...
  const InviteView({Key key, this.animationController, this.animation})
      : super(key: key);
...
class _InviteViewState extends State<InviteView> {
  final _keyFormInvite = GlobalKey<FormState>();
  ...
  void initState() {
    ...
    address.value = new TextEditingValue(text: "");
  }
                                  ...
                                  children: <Widget>[
                                    textAboveLineWidget(
                                        AppLocalizations.of(context).translate(
                                            "You can issue the invitation to a specific identity address"),
                                        16),
                                    lineWidget(70),
                                    Padding(
