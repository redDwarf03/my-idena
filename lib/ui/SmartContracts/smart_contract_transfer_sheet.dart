...
class SmartContractTransferSheet extends StatefulWidget {
  final String title;
  ...
  _SmartContractTransferSheetState createState() =>
      _SmartContractTransferSheetState();
}

enum AddressStyle { TEXT60, TEXT90, PRIMARY }

class _SmartContractTransferSheetState
    extends State<SmartContractTransferSheet> {
